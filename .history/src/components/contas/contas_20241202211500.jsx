    ...
    <div className="p-2 text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-900 to-black">
      ...
      <div className="dashboard">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="card">
              {/* despesas mensais nao esta funcionando*/}
            <GraficoReceitaDespesas receita={receita} despesa={despesa} />
          </div>
          <div className="card">
              {/* Filtrando os dados de "Saída" para o gráfico de pizza do mes atual nao esta funcionando*/}
            <GraficoColunas data={data} />
          </div>
          <div className="card">
              {/* tabela de Anlise de tipo_caegoria agrupada Funcionando correamtnete */}
            <TabelaCategoria data={data} />
          </div>
          <div className="card">
              {/* Grafico de pizza analise contas Pendente e Concluido de contas de Saída */}
