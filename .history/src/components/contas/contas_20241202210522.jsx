...
function Contas() {
  ...
  // Filtrando os dados com base na data e na situação
  ...
  // Agrupando os dados por categoria e mês
  ...
  return (
    <div className="p-2 text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-900 to-black">
      ...
      <div className="dashboard">
        ...
        <div className="card">
  {/* Filtrando apenas os dados com tipo_registro "Saída" para o gráfico de pizza */}
  <GraficoPizza data={data.filter(item => item.tipo_registro === "Saída")} />
</div>

          <div className="card">
            {/* Enviando receita e despesa separadas para o gráfico de receita/despesa */}
            <GraficoReceitaDespesas receita={receita} despesa={despesa} />
          </div>
          <div className="card">
            {/* Enviando os dados agrupados por categoria e mês para o gráfico de colunas */}
          ...
          <div className="card">
            {/* Enviando dados para o gráfico geral, agrupados por situação */}
