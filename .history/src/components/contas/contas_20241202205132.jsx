    ...
    <div className="p-2 text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-900 to-black">
      ...
      <div className="dashboard">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-2">
          <div className="col-span-1 p-4 max-w-8 rounded-lg w-60 shadow-xl bg-gradient-to-r from-neutral-900 from-10% via-slate-900 via-30% border-t-stone-950 to-90%">
