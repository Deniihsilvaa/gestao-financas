    ...
    <div className="p-4 text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-900 to-black">
      <div className="dashboard">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="col-span-1 p-4 rounded-lg shadow-xl backdrop-opacity-100 hover:backdrop-opacity-60 bg-gradient-to-r from-neutral-900 from-10% via-slate-900 via-30% to- to-90%">
