...
function Contas() {
  ...
  const type = {
    estilo1: "backdrop-opacity-100 hover:backdrop-opacity-60",
  };
  return (
    <div className="p-4 text-white rounded-lg shadow-xl bg-gradient-to-r from-blue-900 to-black">
      <div className="dashboard">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="col-span-1 p-4 rounded-lg shadow-lg backdrop-opacity-100 hover:backdrop-opacity-60">
            <GraficoPizza data={currentMonthData} />
          </div>
          <div className="col-span-1 p-4 bg-blue-800 rounded-lg shadow-lg">
