...
import GraficoConsolidado from "../Graficos/GraficoMensalConsolidado/grafico_consolidado";
function Contas() {
    ...
    <div className="p-4 text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-900 to-black">
      <div className="dashboard">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="backdrop-saturate-50 bg-white/0">
            <GraficoConsolidado />
          </div>
          <div className="col-span-1 w-">
