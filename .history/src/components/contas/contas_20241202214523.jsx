...
import GraficoReceitaDespesas from "./Graficos/GraficoReceitasDespesas";
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          ...
          <div className="p-4 text-center bg-blue-800 rounded-lg shadow-lg">
            <h5>Saldo</h5>
            <p className="text-xl">{formatCurrency(receita - despesa)}</p> {/* Corrigido para exibir o valor correto */}
          </div>
        </div>
      </div>
